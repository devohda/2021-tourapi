    ...
    const ShowInfos = () => {
        return (
            <View style={[{position: 'absolute', left: 0, bottom: 0}, !visible && {display: 'none'}]}>
                <View style={{backgroundColor: colors.backgroundColor, width: Dimensions.get('window').width, height: 133, borderTopStartRadius: 10, borderTopEndRadius: 10, borderColor: colors.backgroundColor}}>
                    <ScreenContainerView>
                                ...
                                <View style={{flexDirection: 'row', width: '100%'}}>
                                    <View style={{justifyContent: 'center', alignItems: 'center', marginEnd: 12}}>
                                        <View style={{borderRadius: 50, width: 24, height: 24, backgroundColor: colors.mainColor, justifyContent: 'center', alignItems: 'center'}}>
                                            <AppText style={{color: colors.defaultColor, fontSize: 12, lineHeight: 19.2, fontWeight: '500', textAlign: 'center'}}>{checkIndex(currentData.place_pk)}</AppText>
                                        </View>
                                    </View>
                                    {
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{marginLeft: 8, marginTop: '2%'}}>
                                            <View style={{flexDirection: 'row'}}>
                                                ...
                                                <View style={[{flexDirection: 'row'}, parseInt(currentData.review_score) == -1 && {display: 'none'}]}>
                                                <AppText style={{
                                            ...
                                            <AppText
                                                style={{fontSize: 12, color: colors.gray[4]}}>{currentData.place_addr}</AppText>
                                        </View>
                                    </View>
                                </View>
                            </TouchableOpacity>
        ...
        return (
            <View style={{position: 'absolute', right: 10, bottom: visible? 153 : 10}}>
                <TouchableOpacity onPress={()=>{
                    ...
                    <Image source={require('../../assets/images/map/search-location-button.png')} style={{width: 50, height: 50}}/>
                </TouchableOpacity>
            </View>
        );
    };
