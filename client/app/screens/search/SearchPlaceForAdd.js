            ...
            <View style={{
                ...
                >
                    <View style={[{
                        ...
                        alignItems: 'center'
                    }, isPress[index] ? {backgroundColor: colors.gray[6]} : {backgroundColor: colors.mainColor}]}>
                    ...
                    placeList.length === 0 ?
                        ...
                        <SafeAreaView>
                            <FlatList data={placeList} renderItem={PlaceContainer}
                                      keyExtractor={(item, index) => item.place_pk.toString()}
                                      key={(item, index) => item.place_pk.toString()} nestedScrollEnabled/>
                        </SafeAreaView>
                }
            </ScrollView>
        </View>
