    ...
    const navMain = () => {
        ...
        return (
            <Stack.Navigator initialRouteName="main">
                ...
                // options={{title:'자유보관함 만들기', headerStyle:{backgroundColor: '#FCF6F5', elevation: 0, shadowOpacity: 0}, headerTitleStyle:{fontSize: 16, color: '#40516E', fontWeight: 'bold', paddingLeft: '20%'}, 
